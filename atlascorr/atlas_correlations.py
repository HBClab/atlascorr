...
# Step 1: parse BIDS derivative input directory (e.g. fmriprep)

# Step 2: use the subject's mask

# step 3: extract timeseries from each parcel

# step 4: Create correlation matrix for each subject

# step 5: do roi-roi correlations and save each roi-roi correlation as a column

# Inputs
# BIDS derivatives directory (e.g. fmriprep with images in standard space)
